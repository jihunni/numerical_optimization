function [x, y, x_all_iteration, y_all_iteration] = quasi_netwons_method_BFGS(objective_function, x, y, termination_condition)
...
% to measure the performance
    ...
    while(iteration < 5 | ...
        ...
        B_inverse = (I- rho * S * transpose(Y)) * B_inverse * (I - rho * Y * transpose(S)) + rho * S * transpose(S);
